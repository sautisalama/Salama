# Generated by Django 5.0.2 on 2024-08-02 11:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ngo', 'NGO'), ('professional', 'Professional'), ('survivor', 'Survivor')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survivor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.customuser')),
                ('professional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.professionalprofile')),
            ],
        ),
    ]
